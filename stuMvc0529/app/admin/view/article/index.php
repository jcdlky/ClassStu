...
<div class="page-container">
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="pull-right no-text-shadow">
                            ...
                            <div class="range">
                                <span><a href="index.php?s=admin/article/add">发布文章</a></span>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" style="    width: 180px;">
                                            <!--                                <a href="index.php?s=admin/article/look&name=--><?php //echo $v['gname']; ?><!--" class="btn btn-primary">查看</a>-->
                                            <a href="index.php?s=admin/article/edit&id=<?php echo $v['id']; ?>" class="btn btn-primary">编辑</a>
    ...
    <script>
        ...
        //         location.href = 'index.php?s=admin/article/delete&id=' + id;
        //     }
        // }
        ...
        function del(id) {
            if (confirm('确定删除该班级吗?')) {
                //如果确定要删除,发送ajax
                $.ajax({
                    url:'index.php?s=admin/article/ajaxDelete&id=' + id,
